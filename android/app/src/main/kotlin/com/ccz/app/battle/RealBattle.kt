 ...
 * from each hero's combat strength. Deploy levels are battle design; real heroes carry no skill in the ore,
 * so the generator grants a basic attack. Same content → [CampaignAssembler] → [com.ccz.core.battle.Gameplay]
 * path as [DemoBattle]; the presentation layer holds zero combat truth. The level × growth × grade levers
 * make the roster's panels visibly differ — an elite (关羽, grade 2 level 8) outscales a rookie (邓茂, grade 0).
 */
object RealBattle {
